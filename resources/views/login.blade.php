...
<html lang="en">
    <head>
        ...
        <base href="http://localhost:8080/ITShop/">
                    ...
                    <section class="login_content">
                        <form action="cpanel/auth/login" method="post">
                            ...
                            <div>
                                ...
                                <label for="remember">Ghi nhớ mật khẩu và tài khoản</label>
                                <input type="checkbox" name="remember" <?= $data['datas'] != NULL ? $data['datas']['remember'] == 1?'checked':'':'' ?> id="remember" value="1">
                            </div>
